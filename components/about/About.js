...
const About = () => (
  <section id="about-us" className={styles.section}>
    ...
    <p>
      ...
      asigurării celui mai bun răspuns la nevoile şi problemele de sănătate ale
      populaţiei în ansamblu şi ale pacientului în mod individual.
    </p>
    <p>
      ...
      identificarea şi evitarea efectelor adverse ale medicamentelor, asigurarea
      accesului la medicaţie prin prepararea medicamentelor etc. Serviciile
      farmaceutice sunt parte a sistemului de sănătate şi au ca scop
      îmbunătăţirea stării de sănătate şi creşterea calităţii vieţii populaţiei.
    </p>
